...
/// Legacy backend feed service - kept for backward compatibility
/// Use FeedService protocol with InMemoryFeedService for new feed feature
final class BackendFeedService {
