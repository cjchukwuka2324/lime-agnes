-- ============================================
-- Function: get_all_trending_posts
-- Description: Gets all posts that have any hashtag, sorted by engagement (likes) within a time window
-- This is used for the default "Trending" feed view
-- ============================================
...
BEGIN
    ...
    -- Return posts that have any hashtag, sorted by like count
    RETURN QUERY
    ...
    -- Get reply count (alias the subquery column to avoid ambiguity)
    LEFT JOIN (
    ...
    -- Sort by likes (most popular first), then by recency
